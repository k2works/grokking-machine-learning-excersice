...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 96 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 81 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 82 |

ライブラリ版は 22 本中 7 本を執筆済みです。
