...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 67 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 59 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 60 |

ライブラリ版は 22 本中 5 本を執筆済みです。
