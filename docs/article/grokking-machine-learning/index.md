...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 186 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 154 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 157 |

ライブラリ版は 22 本中 13 本を執筆済みです。
