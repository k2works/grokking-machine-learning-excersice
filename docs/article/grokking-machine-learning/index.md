...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 52 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 46 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 47 |

ライブラリ版は 22 本中 4 本を執筆済みです。
