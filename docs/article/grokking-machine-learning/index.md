...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 198 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 165 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 168 |

ライブラリ版は 22 本中 14 本を執筆済みです。
