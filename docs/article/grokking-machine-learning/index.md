...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 39 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 34 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 35 |

ライブラリ版は 22 本中 3 本を執筆済みです。
