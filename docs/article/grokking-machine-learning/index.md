...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 79 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 70 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 71 |

ライブラリ版は 22 本中 6 本を執筆済みです。
