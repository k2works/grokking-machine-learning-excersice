...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 126 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 103 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 104 |

ライブラリ版は 22 本中 9 本を執筆済みです。
