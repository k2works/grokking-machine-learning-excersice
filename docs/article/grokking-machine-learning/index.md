...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 28 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 25 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 26 |

ライブラリ版は 22 本中 2 本を執筆済みです。
