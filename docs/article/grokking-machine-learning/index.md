...
| ライブラリ | Python | `apps/grokking-ml-python-lib` | `uv run pytest` | 112 |
| ライブラリ | Kotlin | `apps/grokking-ml-kotlin-lib` | `./gradlew test` | 92 |
| ライブラリ | F# | `apps/grokking-ml-fsharp-lib` | `dotnet test` | 93 |

ライブラリ版は 22 本中 8 本を執筆済みです。
