...
複数言語を横断して比較しながら、TDD、関数型プログラミング、並行処理、設計パターン、機械学習、データベース設計、コンテナ実践を段階的に学べます。
...
| [Grokking Machine Learning](grokking-machine-learning/index.md) | 機械学習アルゴリズム | 3 | 線形回帰から決定木・ニューラルネットまで、ML ライブラリに頼らず自前実装して学べます。 |
...
- 機械学習アルゴリズムの中身を理解したい場合は、[Grokking Machine Learning](grokking-machine-learning/index.md) を参照してください。
...
- [Grokking Machine Learning 3 言語統合比較](grokking-machine-learning/all/index.md)
...
- [Grokking Machine Learning 原著サンプルコード](https://github.com/luisguiserrano/manning)
